...
//global $baseUrl1;
//$baseUrl = "http://localhost:81/testcode/fckeditor/upload/"; // chay ok
// $fullpath = 'http://'.$_SERVER['HTTP_HOST']. $_SERVER['REQUEST_URI'];
//$baseUrl = $fullpath .'/upload/';
//die('========'.$_SESSION['_baseUrl1']);
// $baseUrl = 'http://localhost:81/vic_hpn/public/scripts/ckeditor_upload/';
$baseUrl = 'http://'.$_SERVER['HTTP_HOST']. '/Scripts/ckeditor_upload/';
